...
public enum DisplayMode: Equatable, Hashable {
    ...
    case paused
    case override
    case performance   // a marked performance track is playing (custom audience view)
}
...
public struct DisplayState: Equatable, Hashable {
    ...
    public var nextTrackIsPerformance: Bool = false  // true when the next tanda starts with a performance track
